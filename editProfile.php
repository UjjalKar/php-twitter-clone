	...
	if(isset($_POST['screenName'])) {
		if(!empty($_POST['screenName'])) {
			...
			if(strlen($screenName) > 20) {
				...
				$result = $getFromU->update('users', $user_id, array(
	...
	<div class="nav">
		<div class="nav-left">
			<ul>
				...
				<li><a href="i/notifications"><i class="fa fa-envelope" aria-hidden="true"></i>Messages</a></li>
				<!-- <li><a href="i/notifications"><i class="fa fa-envelope" aria-hidden="true"></i>Messages</a></li> -->
			</ul>
		</div>
		<!-- nav left ends-->
...
<div class="profile-nav">
	<div class="profile-navigation">
		...
		<div class="edit-button">
			<span>
				<button class="f-btn" onclick="window.location.href='<?php echo $user->username; ?>'" type="button" value="Cancel">Cancel</button>
			</span>
			<span>
				
				<button class="addTweetBtn" id="edit">Save</button>
			</span>
