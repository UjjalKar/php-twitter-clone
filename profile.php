<?php  
	...
	if(isset($_GET['username']) === true && empty($_GET['username']) === false) {
		...
		if($getFromU->loggedIn() === true) {
			$user1 = $getFromU->userData($_SESSION['user_id']);
	...
	<div class="nav-container">
		...
		<div class="nav-right">
			<ul>
				...
				<?php if($getFromU->loggedIn() === true) { ?>
				<li class="hover"><label class="drop-label" for="drop-wrap1"><img src="<?php echo BASE_URL.$user1->profileImage; ?>"/></label>
				<input type="checkbox" id="drop-wrap1">
				<div class="drop-wrap">
					<div class="drop-inner">
						<ul>
							<li><a href="<?php echo BASE_URL.$user1->username; ?>"><?php echo $user1->username; ?></a></li>
			...
			<?php } else {
				echo '<li><a href="'.BASE_URL.'index.php">Have an account? log in!</a>';
			}?>
			</ul>
		</div><!-- nav right ends-->
